...
CREATE TABLE `competenceprofile` (
  ...
  `CompetenceName` varchar(45) NOT NULL,
  `Comment` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Username`),
  KEY `competenceName_idx` (`CompetenceName`),
  CONSTRAINT `competenceName` FOREIGN KEY (`CompetenceName`) REFERENCES `competence` (`CompetenceName`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2016-03-14 23:04:36
